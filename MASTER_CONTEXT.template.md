...
_Edit or replace with your real brand blocks. A starter template lives at `skills/arcads-external-api/prompting/brand-voice-starter.md`._
...
- **2026-08-22** — Decision: vendored the `arcads-claude-code` skill pack into this repo. What changed: added `skills/`, `shared/`, `scripts/`, `.claude/skills/`, `.cursor/skills/`, `.env.example`, this file. Why: requested installation of the Arcads Claude Code skill.
